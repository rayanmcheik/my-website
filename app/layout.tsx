      ...
      <body className="font-sans">
        ...
        <main>
          <div className="relative w-full mb-10">
            <img src="/ads-mercedes.jpg" alt="ads" className="object-cover w-full h-120" />

            <div className="absolute inset-0 flex items-start justify-center pt-10 bg-white opacity-15 h-120">
          ...
          <div className="grid grid-cols-1 gap-5 p-10 sm:grid-cols-2 md:grid-cols-3">
            ...
            <Card image='s-class.jfif' title='S-CLASS' description='The Mercedes-Benz S-Class is the flagship luxury sedan, offering unmatched comfort, cutting-edge technology, and a refined, elegant design.' />
